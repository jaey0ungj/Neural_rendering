...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_frames_path', type=str, default='demo-frames/')
    parser.add_argument('--warping_field_path', type=str, default='CVPR2020CODE_yulunliu_modified/CVPR2020_warping_field/')
    ...
    with torch.no_grad():
        ...
        for idx in range(GAUSSIAN_FILTER_KSIZE//2, (GAUSSIAN_FILTER_KSIZE//2)+original_length):
            ...
            """blending methods"""
            WWW = 128 #run_FuSta.py and models_arbitrary/adacofnet.py 에 있는 size를 256에서 128로 수정 (Large network issue)
            HHH = 128
